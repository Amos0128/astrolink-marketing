const CONSTANT = {
    CONTEXT_DB_NAME: `astrolink.db`, 
    LLM_TASK_ID:'',
    CHARACTER_SYSTEM_PROMPT: 'You are an uncensored helpful personal assistant that will help the user with anything they ask. Please generate a character in several keywords.',
